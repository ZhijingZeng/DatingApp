...
export class MembersService {
  ...
  getMember(username: string) {
    const member = [...this.memberCache.values()]//still has result and pagination
      .reduce((arr, elem) => arr.concat(elem.result), [])//only taken result and flatten the array
  ...
  updateMember(member: Member) {
    ...
    //     this.members[index] = { ...this.members[index], ...member }//shallow copy https://www.youtube.com/watch?v=M9Af2RNE9xU,
    //properties of objects in the back will take over the properties of objects in the front.
    //all the properties will be added together 
    //   })
    // )
